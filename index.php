...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="css/dq.css"> <!-- Resource style -->
        ...
        <title>Digital Quiz V1 d</title>
    </head>
    <body ng-app="dq">
        <header class="cd-main-header">
            <a href="#0" class="cd-logo"><img src="img/logo/DigitalQuiz.png" style="height: 30px;" alt="Logo"></a>
        ...
        <script src="js/ng/angular-route.js"></script>
        <script src="js/ng/dq.js"></script>
